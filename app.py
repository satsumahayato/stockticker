...
@app.route('/') # Accessing the root directory will redirect the user to /index
def main():
   return redirect('/index')

@app.route('/index', methods=['GET']) # Accessing /index will redirect the user to index.html
def index():
   return render_template('index.html')
   # render_template() will render a template from the template folder with the given context
...
def graph():
   ...
   data = { "function": "TIME_SERIES_DAILY_ADJUSTED",
            ...
            "outputsize" : "full",
            "datatype": "json",
            "apikey": "P22NFYC34VLFM5XH" } # API key acquired by H.O. on 09/09/2020.
